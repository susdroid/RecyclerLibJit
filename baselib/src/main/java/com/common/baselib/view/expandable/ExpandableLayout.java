package com.common.baselib.view.expandable;
...
/**
 * Created by Sudroid on 2019/4/9.
 */
public class ExpandableLayout extends RelativeLayout {
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        headerLayout.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                onClickHeaderListener.onHintResult();
                if (!isAnimationRunning) {
                    if (contentLayout.getVisibility() == VISIBLE) {
                        collapse(contentLayout);
                        onClickHeaderListener.onResult(true);
                    } else {
                        expand(contentLayout);
                        onClickHeaderListener.onResult(false);
                    }
    ...
    public void enableExpend(boolean isClose) {
        isAnimationRunning = isClose;
    }
    ...
    public interface OnClickHeaderListener {
        void onResult(boolean isHorizonal);
