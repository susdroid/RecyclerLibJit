 ...
 */
@SuppressLint("NewApi")
public class YcRefreshHeaderWhite extends RelativeLayout implements RefreshHeader {
    private TextView mTextView;
    private ImageView mProgressBar;
    private boolean isArrowDown = false;
    private AnimationDrawable animationDrawable;

    public YcRefreshHeaderWhite(Context context) {
        super(context);
        this.initView(context, null, 0);
    }

    public YcRefreshHeaderWhite(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs, 0);
    }

    public YcRefreshHeaderWhite(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        View headerView = View.inflate(context, R.layout.item_refresh_header_white, null);
