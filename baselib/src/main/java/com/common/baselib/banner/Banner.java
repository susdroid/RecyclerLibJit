...
import com.common.baselib.banner.listener.OnBannerListener;
import com.common.baselib.banner.loader.ImageLoaderInterface;
import com.common.baselib.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.Banner_banner_default_image, R.mipmap.ic_banner_default);
        typedArray.recycle();
    }
